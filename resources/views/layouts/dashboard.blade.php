...
<head>
    ...
    <title>Online Travel and Tour system</title>
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav me-auto mt-md-0 ">
                        <li class="nav-item search-box">
                            <a class="nav-link text-muted" href="javascript:void(0)"><img src="{{ asset('images/search.png') }}" alt="user" class="profile-pic me-2"></a>
                            <form class="app-search" style="display: none;"method="post" action="">
                                 @csrf
                                <input type="text" name="fullname" class="form-control" placeholder="Search by using &amp; flight name"> <a
                                    class="srh-btn"><img src="{{ asset('images/cross.png') }}" alt="user" class="profile-pic me-2"></a> </form>
                        </li>
                    </ul>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                ...
                                <i class="mdi me-2 mdi-account-check"></i><span class="hide-menu">Add a Flight</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="/admin/flights" aria-expanded="false">
                                <i class="mdi me-2 mdi-account-check"></i><span class="hide-menu">All added Flights</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="/admin/users" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span
                                    class="hide-menu">ALl registered Users</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="/admin/places/create" aria-expanded="false"><i class="mdi me-2 mdi-earth"></i><span
                                    class="hide-menu">Add Places for recommendation</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="/admin/places" aria-expanded="false"><i
                                    class="mdi me-2 mdi-emoticon"></i><span class="hide-menu">Check All Recommended Places</span></a></li>
